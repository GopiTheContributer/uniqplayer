...
namespace UniqPlayer
{
    public partial class UniqPlayer : Form
    {
        ...
        private void DecryptFile(bool fromOpen, string[] selectedFiles)
        {
            ...
            {
                string path = Path.GetDirectoryName(selectedFiles[0]);
        ...
        private string[] OpenDialogFunctionalities()
        {
            ...
            if ((openDialog.ShowDialog() == DialogResult.OK))
                DecryptFile(true, openDialog.FileNames);
